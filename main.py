...
if __name__ == '__main__':
    ...
    args = {
        'MODEL_NAME': '/home/Eliwii_Keeya/mnt/.ek/RWKV-x070-Pile-168M-20241120-ctx4096', #模型文件的名字，pth结尾的权重文件。
    ...
    model = RWKV_RNN(args)
    tokenizer = Tokenizer.from_file("tmp/RWKV7_Mindspore/20B_tokenizer.json")
    print("Done.")
    ...
    # 编码初始字符串
    token = mindspore.Tensor(tokenizer.encode(initial_string).ids, dtype=mindspore.int64).expand([BATCH_SIZE, -1])
